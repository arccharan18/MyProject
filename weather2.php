...
<input type="text" name="city" placeholder="Enter city name" size="100" value="<?php echo $city ?>" required style="height: 50px;font-weight:bold;">
<input type="submit" name="submit" value="Get Weather" style="border: 2px solid #555; border-radius: 12px; box-shadow: 0 0 5px #888; background-color: #ddd; color: #333; font-weight: bold; padding: 8px 16px;">
</form>
</body>
</html>
